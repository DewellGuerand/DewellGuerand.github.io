export const siteConfig = {
  ...
  experience: [
    {
      company: "LSM Investment Club",
      title: "Quantitative Analyst",
      dateRange: "Oct 2025 - Present",
      link: "https://lsminvestmentclub.com",
      bullets: [
        "Conducting quantitative analysis to support investment decisions",
        "Developing financial models to forecast market trends",
