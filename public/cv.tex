...
\begin{document}
    ...
    \section{Experience}
        ...
        \begin{onecolentry}
            \begin{highlights}
                ...
                \item Presentation, reading, and popularization of scientific articles
            \end{highlights}
        \end{onecolentry}
        % \begin{twocolentry}{
        %     From September 2023 
    ...
    \section{Projects}
        ...
        \begin{twocolentry}{
            ...
            \textbf{Disease detection}\end{twocolentry}
        \vspace{0.10 cm}
        \begin{onecolentry}
            \begin{highlights}
                \item Machine learning project focused on disease detection in patients using a CNN and learning models (XGBoost, RandomForest)
                \item Tools: Python
            \end{highlights}
        \end{onecolentry}
        \vspace{0.2 cm}
    ...
    \begin{itemize}
        ...
        \item \textbf{English} : C1 (IELTS 7.0)
        \item \textbf{Dutch} : B2 
